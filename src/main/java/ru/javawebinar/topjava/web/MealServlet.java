...
public class MealServlet extends HttpServlet {
        ...
        switch (action == null ? "all" : action) {
            ...
            default:
                ...
                request.setAttribute("meals",
                        repository.getAllFilter(startTime, finishTime, SecurityUtil.authUserCaloriesPerDay()));
    ...
    private LocalDateTime getStartTime(HttpServletRequest request) {
    ...
    private LocalDateTime getFinishTime(HttpServletRequest request) {
        String finish = request.getParameter("finishTime");
        if (finish != null && !finish.isEmpty()) {
            return LocalDateTime.parse(finish);
        }
        return null;
    }
